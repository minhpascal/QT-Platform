 ...
 * @author Miquel Sas
 */
public class FieldOpen extends Field {

	/**
	 * Constructor.
	 */
	public FieldOpen(Session session, Instrument instrument, String name) {
		super(Domains.getDouble(session, name, "Open", "Open value"));
