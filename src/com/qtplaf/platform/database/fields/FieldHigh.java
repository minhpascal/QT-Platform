 ...
 * @author Miquel Sas
 */
public class FieldHigh extends Field {

	/**
	 * Constructor.
	 */
	public FieldHigh(Session session, Instrument instrument,  String name) {
		super(Domains.getDouble(session, name, "High", "High value"));
