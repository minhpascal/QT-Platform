 ...
 * @author Miquel Sas
 */
public class FieldClose extends Field {

	/**
	 * Constructor.
	 */
	public FieldClose(Session session, Instrument instrument, String name) {
		super(Domains.getDouble(session, name,	"Close", "Close value"));
