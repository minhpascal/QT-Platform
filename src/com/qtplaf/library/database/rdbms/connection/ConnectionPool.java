...
public class ConnectionPool {
	...
	public Connection getConnection() throws SQLException {
		synchronized (lock) {
			...
			Connection underlyingConnection = DriverManager.getConnection(url, user, password);
			PoolableConnection connection = new PoolableConnection(underlyingConnection);
			connection.setClosed(false);
			connection.setAutoCommit(false);
