 ...
 * @author Miquel Sas
 */
public abstract class DefaultActionExecute extends AbstractAction {
	 ...
	 */
	public DefaultActionExecute(Session session) {
		super();
		ActionUtils.setSourceName(this, session.getString("actionExecuteName"));
		ActionUtils.setShortDescription(this, session.getString("actionExecuteName"));
