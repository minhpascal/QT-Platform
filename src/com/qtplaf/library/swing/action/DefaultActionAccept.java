 ...
 * @author Miquel Sas
 */
public abstract class DefaultActionAccept extends AbstractAction {
	 ...
	 */
	public DefaultActionAccept(Session session) {
		super();
		ActionUtils.setSourceName(this, session.getString("actionAcceptName"));
		ActionUtils.setShortDescription(this, session.getString("actionAcceptName"));
