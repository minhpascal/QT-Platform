 ...
 * @author Miquel Sas
 */
public abstract class DefaultActionCancel extends AbstractAction {
	 ...
	 */
	public DefaultActionCancel(Session session) {
		super();
		ActionUtils.setSourceName(this, session.getString("actionCancelName"));
		ActionUtils.setShortDescription(this, session.getString("actionCancelName"));
