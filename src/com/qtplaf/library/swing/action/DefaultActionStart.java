 ...
 * @author Miquel Sas
 */
public abstract class DefaultActionStart extends AbstractAction {
	 ...
	 */
	public DefaultActionStart(Session session) {
		super();
		ActionUtils.setSourceName(this, session.getString("actionStartName"));
		ActionUtils.setShortDescription(this, session.getString("actionStartName"));
		...
		ActionUtils.setSmallIcon(this, ImageIconUtils.getImageIcon("images/gif/execute.gif"));
	}
}
