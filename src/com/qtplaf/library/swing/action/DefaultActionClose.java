 ...
 * @author Miquel Sas
 */
public abstract class DefaultActionClose extends AbstractAction {
	 ...
	 */
	public DefaultActionClose(Session session) {
		super();
		ActionUtils.setSession(this, session);
		ActionUtils.setSourceName(this, session.getString("actionCloseName"));
		ActionUtils.setShortDescription(this, session.getString("actionCloseName"));
