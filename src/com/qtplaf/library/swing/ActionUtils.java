...
public class ActionUtils {
	...
	/**
	 * Initial setup of the accept action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionAccept(Session session, Action action) {
		...
		setSmallIcon(action, ImageIconUtils.getImageIcon("images/gif/accept.gif"));
	}

	/**
	 * Initial setup of the cancel action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionCancel(Session session, Action action) {
		...
		setSession(action, session);
		setActionGroup(action, ActionGroup.Edit);
		setSmallIcon(action, ImageIconUtils.getImageIcon("images/gif/cancel.gif"));
	}

	/**
	 * Initial setup of the close action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionClose(Session session, Action action) {
		setSourceName(action, session.getString("actionCloseName"));
		setShortDescription(action, session.getString("actionCloseName"));
		setAcceleratorKey(action, KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0));
		setSession(action, session);
		setActionGroup(action, ActionGroup.Edit);
		setSmallIcon(action, ImageIconUtils.getImageIcon("images/gif/close.gif"));
	}

	/**
	 * Initial setup of the exit action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionExit(Session session, Action action) {
	...
	/**
	 * Initial setup of the start action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionStart(Session session, Action action) {
		...
		setSmallIcon(action, ImageIconUtils.getImageIcon("images/gif/execute.gif"));
	}

	/**
	 * Initial setup of the stop action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionStop(Session session, Action action) {
		...
		setSession(action, session);
		setActionGroup(action, ActionGroup.Operation);
		setSmallIcon(action, ImageIconUtils.getImageIcon("images/gif/stop.gif"));
	}

	/**
	 * Initial setup of the select action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionSelect(Session session, Action action) {
	...
	/**
	 * Initial setup of the ascending action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionAscending(Session session, Action action) {
		setName(action, session.getString("actionAscendingName"));
		setShortDescription(action, session.getString("actionAscendingName"));
		setSession(action, session);
	}

	/**
	 * Initial setup of the descending action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionDescending(Session session, Action action) {
		setName(action, session.getString("actionDescendingName"));
		setShortDescription(action, session.getString("actionDescendingName"));
		setSession(action, session);
	}

	/**
	 * Initial setup of the down action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionDown(Session session, Action action) {
		setShortDescription(action, session.getString("actionDownShortDesc"));
		setSmallIcon(action, new IconArrow(IconArrow.Direction.Down));
		setSession(action, session);
	}

	/**
	 * Initial setup of the left action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionLeft(Session session, Action action) {
		setShortDescription(action, session.getString("actionLeftShortDesc"));
		setSmallIcon(action, new IconArrow(IconArrow.Direction.Left));
		setSession(action, session);
	}

	/**
	 * Initial setup of the right action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionRight(Session session, Action action) {
		setShortDescription(action, session.getString("actionRightShortDesc"));
		setSmallIcon(action, new IconArrow(IconArrow.Direction.Right));
		setSession(action, session);
	}

	/**
	 * Initial setup of the up action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionUp(Session session, Action action) {
		setShortDescription(action, session.getString("actionUpShortDesc"));
		setSmallIcon(action, new IconArrow(IconArrow.Direction.Up));
		setSession(action, session);
	}

	/**
	 * Initial setup of the select columns action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionSelectColumns(Session session, Action action) {
		setSourceName(action, session.getString("actionColumnsName"));
		setShortDescription(action, session.getString("actionColumnsName"));
		setAcceleratorKey(action, KeyStroke.getKeyStroke(KeyEvent.VK_C, KeyEvent.CTRL_DOWN_MASK));
		setSession(action, session);
		setActionGroup(action, ActionGroup.Operation);
		setSmallIcon(action, ImageIconUtils.getImageIcon("images/gif/columns.gif"));
	}

	/**
	 * Initial setup of the sort table action.
	 * 
	 * @param session The working session.
	 * @param action The action.
	 */
	public static void setupActionSortTable(Session session, Action action) {
		setSourceName(action, session.getString("actionSortName"));
		setShortDescription(action, session.getString("actionSortName"));
		setAcceleratorKey(action, KeyStroke.getKeyStroke(KeyEvent.VK_S, KeyEvent.CTRL_DOWN_MASK));
		setSession(action, session);
		setActionGroup(action, ActionGroup.Operation);
		setSmallIcon(action, ImageIconUtils.getImageIcon("images/gif/sort.gif"));
	}
}
