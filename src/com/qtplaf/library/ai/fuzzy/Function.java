...
/**
 * The function to compute the value (factor) within the range of a segment in fuzzy control.
 *
 * @author Miquel Sas
 */
public interface Function {
	 ...
	 * @return The factor.
	 */
	double getFactor(double value, double maximum, double minimum, int sign);
}
