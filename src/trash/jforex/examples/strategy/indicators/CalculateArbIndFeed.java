...
@RequiresFullAccess
public class CalculateArbIndFeed implements IStrategy {
    ...
    public void onStart(IContext context) throws JFException {
      ...
      //retrieve indicator metadata
        ...
        for(int i = 0; i < optInputCount; i++){
            ...
            optParams[i] = descr.getOptInputDefaultValue();
            print("Set default opt input: %s=%s",optInfo.getName(),optParams[i]);
        }
